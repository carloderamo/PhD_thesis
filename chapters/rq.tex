...
% \begin{minipage}{\columnwidth}
% \centering
%   \subfigure[RQ-Learning{F:hasselt_qdectol}]{\includegraphics[scale=.7]{./imgs/gridHasseltTol/QDecHasselt.pdf}\hspace{-.5cm}}
%   \subfigure[Windowed RQ-Learning{F:hasselt_qdecwintol}]{\includegraphics[scale=.7]{./imgs/gridHasseltTol/QDecWinHasselt.pdf}}
% \end{minipage}
